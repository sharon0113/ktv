...
from pptv_live.sports import get_list,spider, read_m3u8, read_ts, get_precast, read_live_m3u8, read_llve_ts, get_current_live
urlpatterns = patterns("",
    ...
    url(r'^pptvlive/readlivets[0-9]*.ts',read_live_ts),
